...
public class SamlLoginWithLocalIdpIT {
    ...
    public void idp_initiated_login() throws Exception {
        ...
        SamlServiceProviderDefinition samlServiceProviderDefinition = createZone2SamlSpDefinition("testzone2.cloudfoundry-saml-login");
        ...
        SamlIdentityProviderDefinition samlIdentityProviderDefinition = createZone1IdpDefinition("testzone1.cloudfoundry-saml-login");
        ...
        assertThat(webDriver.getCurrentUrl(), containsString(testZone1Url));
        webDriver.get(baseUrl + "/logout.do");
        webDriver.get(testZone1Url + "/logout.do");
    }
